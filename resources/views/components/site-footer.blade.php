<footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-wide px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-4">
                <p>David Peach</p>
                <p class="leading-6 text-gray-600">Love a good story. Raiding Tombs since 1996.</p>
                <div class="flex space-x-6">
                    <a href="https://twitter.com/carryonmaking" class="text-gray-400 hover:text-gray-500">
                    ...
                    <a href="https://github.com/davidpeach" class="text-gray-400 hover:text-gray-500">
                    ...
                    <a href="https://www.youtube.com/channel/UCJcGgpWP74hLU2walYxfhdQ" class="text-gray-400 hover:text-gray-500">
        ...
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
            <p class="text-xs leading-5 text-gray-500">&copy; David Peach, 2024 All rights reserved.
            </p>
        </div>
    </div>
</footer>
